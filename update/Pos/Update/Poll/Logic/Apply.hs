...
import           Pos.Core (BlockCount, ChainDifficulty (..), Coin, EpochIndex, HeaderHash,
                           IsMainHeader (..), ProtocolMagic, SlotCount, SlotId (siEpoch),
                           ...
                           headerSlotL, kEpochSlots, sumCoins, unflattenSlotId, unsafeIntegerToCoin)

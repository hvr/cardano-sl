...
import           Pos.Core (ApplicationName, BlockCount, BlockVersion, ComponentBlock (..),
                           HasCoreConfiguration, NumSoftwareVersion, ProtocolMagic,
                           SoftwareVersion (..), StakeholderId, addressHash, blockVersionL,
                           epochIndexL, headerHashG, headerLeaderKeyL, headerSlotL, kEpochSlots)

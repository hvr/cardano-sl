...
import           Pos.Core (BlockCount, BlockVersionData (..), EpochIndex, HasGenesisData,
                           ProtocolConstants, SlotId (..), StakeholderId, VssCertificate,
                           epochIndexL, kEpochSlots, mkVssCertificatesMapSingleton,
